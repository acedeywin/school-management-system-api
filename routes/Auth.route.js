...
authRoutes.post('/login',  validateRequest(['identifier', 'password']), deviceMiddleware({}), authController.login.bind(authController))
authRoutes.put('/logout', queryMiddleware({query: 'token' }), authController.logout.bind(authController))
